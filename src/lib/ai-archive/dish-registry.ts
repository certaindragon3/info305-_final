...
export const DISH_REGISTRY: DishArchiveEntry[] = [
    ...
    // ═══════════════════════════════════════════
    {
        ...
        contextPath: '/ai-context/interview_transcript.md',
        ...
        suggestedQuestions: [
            ...
            'What is special about the knife work?',
        ],
    },
    {
        id: 2,
        ...
        suggestedQuestions: [
            'Why is hot oil poured tableside?',
            'How to remove the muddy taste from the eel?',
            'Is this dish sweet?',
        ],
    },
    {
        ...
        suggestedQuestions: [
            ...
            'What is foxnut (Jitoumi)?',
            'Which season is best for this dish?',
        ],
    },
    {
        id: 4,
        ...
        suggestedQuestions: [
            'Why use hand-peeled shrimp?',
            'How to make the shrimp so bouncy?',
            'What kind of shrimp is used?',
        ],
    },
    ...
    // ═══════════════════════════════════════════
    {
        ...
        contextPath: '/ai-context/golden-soy-shrimp.md',
        ...
        suggestedQuestions: [
            'What special ingredients are in the sauce?',
            'Why is it called "Golden" Soy Sauce Shrimp?',
            'What is the secret behind the hot-meets-cold technique?',
        ],
    },
    {
        id: 6,
        ...
        contextSource: 'dianping',
        contextPath: '/ai-context/assorted-delicacies.md',
        ...
        suggestedQuestions: [
            'Why is it called "White Assorted Delicacies"?',
            'What ingredients does this dish contain?',
            'Why does it test a chef\'s fundamental skills?',
        ],
    },
    {
        id: 7,
        ...
        contextSource: 'dianping',
        contextPath: '/ai-context/crab-roe-tofu.md',
        ...
        suggestedQuestions: [
            'Is the crab roe in this dish authentic?',
            'What is the history behind this dish?',
            'What makes its texture so special?',
        ],
    },
    {
        id: 8,
        ...
        contextSource: 'dianping',
        contextPath: '/ai-context/salt-pepper-pork.md',
        ...
        suggestedQuestions: [
            'How to achieve the "crispy outside, tender inside" texture?',
            'What is special about the salt and pepper seasoning?',
            'What cut of pork is used?',
        ],
    },
    {
        id: 9,
        ...
        contextSource: 'dianping',
        contextPath: '/ai-context/wine-lees-fish.md',
        ...
        suggestedQuestions: [
            'What does "Wine Lees" cooking mean?',
            'Does this dish have a strong alcohol taste?',
            'Why are the fish slices so incredibly tender?',
        ],
    },
    {
        id: 10,
        ...
        contextSource: 'dianping',
        contextPath: '/ai-context/sweet-sour-ribs.md',
        ...
        suggestedQuestions: [
            'Exactly how sweet is this dish?',
            'Are the pork ribs deep-fried first?',
            'Why does this dish represent the traditional Suzhou flavor?',
        ],
    },
    {
        id: 11,
        ...
        contextSource: 'dianping',
        contextPath: '/ai-context/whitebait-eggs.md',
        ...
        suggestedQuestions: [
            'What are the "Three Whites of Taihu Lake"?',
            'Does the whitebait have bones?',
            'How are the eggs scrambled so tenderly?',
        ],
    },
    {
        id: 12,
        ...
        contextSource: 'dianping',
        contextPath: '/ai-context/red-bean-soup.md',
        ...
        suggestedQuestions: [
            'What is the meaning and symbolism behind this dessert?',
            'How are the glutinous rice balls made?',
